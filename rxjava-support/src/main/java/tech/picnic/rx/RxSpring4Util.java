...
public final class RxSpring4Util {
     ...
     * @param collector a function that transforms the list of all emitted items into the final
     *     result
     ...
     */
    public static Function<? super Completable, DeferredResult<Void>>
            completableToDeferredResult() {
    ...
    /**
     * Provides a function that subscribes to a {@link Publisher} and exposes its emissions as
     * {@link SseEmitter server-sent events}.
     *
