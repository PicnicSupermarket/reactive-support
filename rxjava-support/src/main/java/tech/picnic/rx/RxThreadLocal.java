...
public final class RxThreadLocal<T> implements io.reactivex.functions.Function<Runnable, Runnable> {
     ...
     *     Scheduler}
     * @param setAndRestore the operation that updates and restores the relevant thread local
     *     context before and after the execution of a scheduled {@link Runnable}
