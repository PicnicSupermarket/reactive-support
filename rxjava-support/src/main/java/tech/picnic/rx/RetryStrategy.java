...
public final class RetryStrategy implements Function<Flowable<Throwable>, Flowable<?>> {
  ...
  /**
   * Creates a {@link RetryStrategy} which retries only upon exceptions of any of the listed types,
   ...
   * @return a {@link RetryStrategy} that triggers a retry when a given error matches the predicate
   */
